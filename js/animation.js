...
const config = {
    name: "So", // actual name of the recipient (Mandatory)

    nickname: "Miriam Oundo", // nickname(optional)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Thank you and All the best";
